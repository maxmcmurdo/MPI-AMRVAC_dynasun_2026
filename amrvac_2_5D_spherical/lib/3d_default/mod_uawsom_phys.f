...
!! end rad cool
      ...
      if(primitive) then
        ...
        if(uawsom_internal_e) then
          ...
          tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
             ...
             ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3) !Max: Added AW + kink
          if(has_equi_pe0) then
            tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
               ixOmin3:ixOmax3) = tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
               ixOmin3:ixOmax3)+block%equi_vars(ixOmin1:ixOmax1,&
  ...
  subroutine uawsom_ei_to_e(ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    w(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,e_)=w(ixImin1:ixImax1,&
       ...
       ixImax2,ixImax3,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3) !Max: Added AW + kink
            ...
            if(uawsom_internal_e) then
              ...
              where(flag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,e_))
                w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
                   ...
                   ixImax1,ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,&
                   ixOmax2,ixOmax3) !Max: Added AW + kink
             end where
              if(uawsom_solve_eaux) then
                where(flag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
                   e_))
  ...
  subroutine uawsom_get_temperature_from_etot(w, x, ixImin1,ixImin2,ixImin3,&
    ...
    res(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)=(gamma_1*(w(&
       ...
       ixOmax3))- uawsom_wA_en(w,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
       ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,&
       ixOmax3))/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_) !Max: added AW + Kink
  ...
  subroutine uawsom_get_flux(wC,w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,&
    ...
    double precision             :: ptotal(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3), denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)
    ...
    if(uawsom_energy) then 
      ptotal(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         ixOmin3:ixOmax3,wAminus_))/2.0d0 !Max: Added AW + Kink pressure
    else
      ptotal(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)=uawsom_adiab*w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    if(uawsom_energy) then
      if (uawsom_internal_e) then
        ...
        f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
           ...
           ixOmin3:ixOmax3)+1.d0)/(2.d0*(1+ff*zeta(ixOmin1:ixOmax1,&
           ixOmin2:ixOmax2,ixOmin3:ixOmax3)-ff))))**0.5d0)+w(ixOmin1:ixOmax1,&
           ...
           ixOmin2:ixOmax2,ixOmin3:ixOmax3)+1.d0)/(2.d0*(1+&
           ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3)-ff))))**0.5d0)+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,wAminus_)*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,mom(idim)) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,mag(idim))/(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,rho_)**0.5d0))+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,wAplus_)*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,mom(idim)) - w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,mag(idim))/(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           ixOmin3:ixOmax3,rho_)**0.5d0))
    ...
    denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = sqrt(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3,rho_)*((zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)+1.d0)/(2.d0*(1+ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3)-ff))))
    ...
    f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       ...
       wkminus_)*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mom(idim))+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mag(idim))/denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3))
  ...
  subroutine uawsom_get_flux_split(wC,w,x,ixImin1,ixImin2,ixImin3,ixImax1,&
    ...
    double precision :: tmp4(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3),&
        denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
    ...
    ptotal(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ...
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,wAminus_))/2.d0 !Max: added AW + kink pressure
    ...
    if(uawsom_energy) then
      if (uawsom_internal_e) then
         ...
         f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
            ...
            ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            ixOmin3:ixOmax3)-ff))))**0.5d0) -w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            ixOmin3:ixOmax3,wkplus_)*B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       ...
       wkminus_)*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       mom(idim))+B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
       idim)/denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3))
    ...
    if (.not. qsourcesplit) then
      if(uawsom_internal_e) then
        ...
        if(uawsom_solve_eaux) then
          ...
          call internal_energy_add_source(qdt,ixImin1,ixImin2,ixImin3,ixImax1,&
             ixImax2,ixImax3,ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,&
             wCT,w,x,eaux_,qsourcesplit,active)
        endif
        if(has_equi_pe0) then
          active = .true.
  ...
  subroutine w_add_source(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    logical, intent(inout)          :: active
    double precision                :: v(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3,1:ndir), Bmag(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), B0(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,3),&
        Bpo, Bzo, y0, kx, Bref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
       3)
    double precision                :: divv(ixImin1:ixImax1,ixImin2:ixImax2,&
    ...
    double precision                :: vA1(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),vA2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       vA3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       gradvA1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       gradvA2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       gradvA3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       refvA(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       lnvA1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       lnvA2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       lnvA3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        gradlnvA1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) ,&
        gradlnvA2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) ,&
        gradlnvA3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) 
    double precision                :: vk1(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),vk2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       vk3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       gradvk1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       gradvk2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       gradvk3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       refvk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       lnvk1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       lnvk2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       lnvk3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        gradlnvk1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) ,&
        gradlnvk2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) ,&
        gradlnvk3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) 
    integer                         :: ix1, ix2, ix3, idirmin

    double precision :: eps_small = 1.0d-30
    double precision :: F(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Ref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        b_1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        b_2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        b_3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        d_lnvA_1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        d_lnvA_2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        d_lnvA_3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        term1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        curlv(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,1:ndir),&
        term2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Rimb(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Rlim(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        vA(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        lnvA(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
    double precision :: Fk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Refk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        v_1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        v_2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        v_3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        d_lnvk_1(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        d_lnvk_2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        d_lnvk_3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        vk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        lnvk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        term1k(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Rlimk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Rimbk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
    ...
    if(B0field) then
      B(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
         ...
         1:ndir,0) !> Magnetic field pertubations change the radius of flux tube
    else
      B(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
         1:ndir)=wCT(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
         mag(1:ndir)) 
    ...
    Bmag(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3) = (B(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3,1)**2.d0 + B(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3,2)**2.d0 + B(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3,3)**2.d0)**0.5d0
    
    !> Below works fine for 1-3D.
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = 1.d8/unit_length * &
       ((Busr/unit_magneticfield)/Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3))**0.5d0 !> 1Mm * sqrt(B_0/B)
    ...
    if(qsourcesplit .eqv. .false.) then
      ...
      call get_zeta(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,zeta)
      
      Lperp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = (zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + 1.d0 - ff)**(3.d0/2.d0)/(1.d0 - &
         ff**(5.d0/2.d0))/(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) - 1.d0)*3.1622776*(ff*dpi)**&
         0.5d0*radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) !/min(pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3),1.d0) 
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         ...
         ixOmin3:ixOmax3)-1.d0)/(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)+1.d0)*(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)+1.d0)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkplus_) + wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkminus_))/4.d0*divv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) 
      ...
      Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = (1.5d9/unit_length)*(1.d0/Bmag(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3))**0.5d0
      ...
      Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         ixOmin3:ixOmax3, wAminus_)/wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,rho_))**0.5d0
      Gamma_minus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = (2.0d0 / Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)) * (wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3, wAplus_)/wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,rho_))**0.5d0

      if(B0field) then
        Bref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
           1:ndir)=wCT(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
           mag(1:ndir))+block%B0(ixImin1:ixImax1,ixImin2:ixImax2,&
           ixImin3:ixImax3,1:ndir,0) !> Magnetic field pertubations change the radius of flux tube
      else
        Bref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
           1:ndir)=wCT(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
           mag(1:ndir)) 
      ...
      Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = (Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1)**2.d0 + Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,2)**2 + Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,3)**2)**0.5d0

      vA(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)/dsqrt(wCT(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,rho_)) !> vA = B/sqrt(rho_avg)
      vk(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)/dsqrt(0.5d0*wCT(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,rho_)*(1+zeta(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3))*((1+ff*zeta(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)-ff)**(-1.d0))) !> vk = B/(sqrt(rho_i+rho_e/2))
      lnvA(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = log(vA(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3))
      lnvk(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = log(vk(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3))

      b_1(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,1)/Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)
      b_2(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,2)/Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)
      b_3(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3) = Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3,3)/Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,&
         ixImin3:ixImax3)

      call gradient(lnvA,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,1,d_lnvA_1)
      call gradient(lnvA,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,2,d_lnvA_2)
      call gradient(lnvA,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,3,d_lnvA_3)

      call gradient(lnvk,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,1,d_lnvk_1)
      call gradient(lnvk,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,2,d_lnvk_2)
      call gradient(lnvk,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3,3,d_lnvk_3) 

      term1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = vA(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) * (b_1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*d_lnvA_1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + b_2*d_lnvA_2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + b_3*d_lnvA_3(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3))
      term1k(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = vk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) * (b_1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*d_lnvk_1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + b_2*d_lnvk_2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + b_3*d_lnvk_3(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3))

      !> coordinate indpendent calculation at wCT of b.curlv
      call uawsom_get_v(wCT,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
         ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,v)
      call curlvector(v, ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
          ixOmin1,ixOmin2,ixOmin3,ixOmax1,ixOmax2,ixOmax3, curlv, idirmin, 1,&
          3)
      term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = b_1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*curlv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,1) + b_2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*curlv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,2) + b_3(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*curlv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,3)
      
      Rimb(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = sqrt(term1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*term1(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3))
      Rimbk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = sqrt(term1k(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*term1k(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3))

      Rlim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)  = min(Rimb(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3), max(Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3), Gamma_minus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)))
      Rlimk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = min(Rimbk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3), max(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkplus_)**(1.d0/2.d0)/(wCT(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)*(1+ff*zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3)-ff)**(-&
         1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3),&
          wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wkminus_)**(1.d0/2.d0)/(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,rho_)*(1+ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)-ff)**(-1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3)))

      F(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)  = 0.0d0
      Fk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = 0.0d0
      ...
      do ix1=ixOmin1,ixOmax1
        do ix2=ixOmin2,ixOmax2
          if (4.0d0*(wCT(ix1,ix2,wAplus_)) <= wCT(ix1,ix2,&
             wAminus_) .and. wCT(ix1,ix2,wAminus_) > eps_small) then
            F(ix1,ix2) = 1.0d0 - 2.0d0*sqrt( wCT(ix1,ix2,wAplus_) / wCT(ix1,&
               ix2,wAminus_))
          elseif (4.0d0*wCT(ix1,ix2,wAminus_) <= wCT(ix1,ix2,&
             wAplus_) .and. wCT(ix1,ix2,wAplus_) > eps_small) then
            F(ix1,ix2) = 2.0d0*sqrt(wCT(ix1,ix2,wAminus_) / wCT(ix1,ix2,&
               wAplus_)) - 1.0d0
          endif
        end do
      end do
      ...
      do ix1=ixOmin1,ixOmax1
        do ix2=ixOmin2,ixOmax2
          if (4.0d0*(wCT(ix1,ix2,wkplus_)) <= wCT(ix1,ix2,&
             wkminus_) .and. wCT(ix1,ix2,wkminus_) > eps_small) then
            Fk(ix1,ix2) = 1.0d0 - 2.0d0*sqrt( wCT(ix1,ix2,wkplus_) / wCT(ix1,&
               ix2,wkminus_))
          elseif (4.0d0*wCT(ix1,ix2,wkminus_) <= wCT(ix1,ix2,&
             wkplus_) .and. wCT(ix1,ix2,wkplus_) > eps_small) then
            Fk(ix1,ix2) = 2.0d0*sqrt(wCT(ix1,ix2,wkminus_) / wCT(ix1,ix2,&
               wkplus_)) - 1.0d0
          endif
        end do
      end do

      Ref(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = Rlim(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) * F(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)
      Refk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = Rlimk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) * Fk(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         ...
         ixOmin3:ixOmax3,rho_)*(1+ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)-ff)**(-1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3) + Refk(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkplus_))**0.5d0) 
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wkplus_)  = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         ...
         wAminus_)*Gamma_minus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) + Ref(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wAminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wAplus_))**0.5d0) 
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wAplus_)  = w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         ...
         wAplus_)*Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)    - Ref(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wAminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wAplus_))**0.5d0) 
  ...
  subroutine internal_energy_add_source(qdt,ixImin1,ixImin2,ixImin3,ixImax1,&
    ...
    double precision                :: Bmag(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), B0(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,3)
    double precision                :: Lperp(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),Lperp_AW(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),Gamma_minus(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),Gamma_plus(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),radius(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3),zeta(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       B(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,3)
    double precision :: Bref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,&
       3), Bmagref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        vA(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        vk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        lnvA(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        lnvk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        ...
        b_2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        b_3(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3)
    double precision :: d_lnvA_1(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), d_lnvA_2(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), d_lnvA_3(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), d_lnvk_1(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), d_lnvk_2(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), d_lnvk_3(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), term1(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3)
    double precision :: term1k(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3), v_r(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        v_theta(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        v_phi(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        term2(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
        curlv(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3,1:ndir)
    double precision :: Fk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       Ref(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       ...
       Rlim(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       Rlimk(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),&
       F(ixImin1:ixImax1,ixImin2:ixImax2,ixImin3:ixImax3),eps_small
    
    double precision :: dxa1,dxa2,dxa3, startpos1,startpos2,startpos3, xlen1,&
        xlen2, xlen3, ixbc1,ixbc2,ixbc3
    integer          :: ix1,ix2,ix3, idirmin, ngl
    ...
    Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3) = (B(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,1)**2.d0 + B(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,2)**2 + B(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,3)**2)**0.5d0
    
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ixOmin3:ixOmax3) = 1.d8/unit_length * (0.5d0/Bmag(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,ixOmin3:ixOmax3))**0.5d0 !> for lmax = 5 with low res run 24x48x96, <|B_surf|> = 0.53 (unit_B)
    ...
    if(qsourcesplit .eqv. .false.) then
      ...
      Lperp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         ff**(5.d0/2.d0))/(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) - 1.d0)*3.1622776*(ff*dpi)**&
         0.5d0*radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3)

      Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = 0.05d0*(1.0d0/Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3))**0.5d0 !> Cooper Downs Lperp_AW fix 1.d0 to base B
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,ie)=w(ixOmin1:ixOmax1,&
         ...
         ixOmin2:ixOmax2,ixOmin3:ixOmax3) + qdt*(wCT(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3,wAminus_)*Gamma_minus(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3) +wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wAplus_)*Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)+ wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         wkplus_)**(3.d0/2.d0)/(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,rho_)*(1+ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)-ff)**(-1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3) +wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkminus_)**(3.d0/2.d0)/(wCT(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3,rho_)*(1+ff*zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,ixOmin3:ixOmax3)-ff)**(-&
         1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)) -qdt*(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)-1.d0)/(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)+1.d0)*(zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3)+1.d0)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3,wkplus_) + wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
  ...
  subroutine get_zeta(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    zeta(ixImin1:ixImax1,ixImin2:ixImax2,&
       ixImin3:ixImax3) = (zeta0-xprobmin2)*exp(-(x(ixImin1:ixImax1,&
       ixImin2:ixImax2,ixImin3:ixImax3,2)-&
       xprobmin2)/(5.d0*6.961d10/unit_length))+1.d0 
