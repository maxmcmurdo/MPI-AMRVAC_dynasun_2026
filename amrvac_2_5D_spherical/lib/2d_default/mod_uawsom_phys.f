...
!! end rad cool
  ...
  subroutine w_add_source(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    !radius(ixO^S) = 1.d8/unit_length * ((Busr/unit_magneticfield)/Bmag(ixO^S))**0.5d0  !> 1Mm * sqrt(B_0/B)
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 1.d8/unit_length * &
       ((1.1d0)/Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2))**0.5d0 !> 1Mm * sqrt(B_0/B)
    ...
    if(qsourcesplit .eqv. .false.) then
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_) = w(ixOmin1:ixOmax1,&
         ...
         rho_)*(1+ff*zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)-ff)**(-1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)) !+ Refk(ixOmin1:ixOmax1,ixOmin2:ixOmax2)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkplus_))**0.5d0) 
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkplus_)  = w(ixOmin1:ixOmax1,&
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_) = w(ixOmin1:ixOmax1,&
         ...
         wAminus_)*Gamma_minus(ixOmin1:ixOmax1,ixOmin2:ixOmax2)) !+ Ref(ixOmin1:ixOmax1,ixOmin2:ixOmax2)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAplus_))**0.5d0) 
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAplus_)  = w(ixOmin1:ixOmax1,&
         ...
         wAplus_)*Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2)) !- Ref(ixOmin1:ixOmax1,ixOmin2:ixOmax2)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAplus_))**0.5d0) 
    endif
  ...
  subroutine get_zeta(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    zeta(ixImin1:ixImax1,ixImin2:ixImax2) = &
       ...
       1)-xprobmin1)/(5.d0*6.961d10/unit_length))+1.d0
