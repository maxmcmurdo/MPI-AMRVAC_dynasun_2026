...
contains
  ...
  subroutine initonegrid_usr(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    double precision, intent(inout) :: w(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:nw)
    double precision :: lat(ixImin1:ixImax1,ixImin2:ixImax2), Br_arc, Bth_arc,&
        deltath, alpha, B0, arcade, shift_arc, shift_dip

    double precision :: MAX0wB02(ixImin1:ixImax1,ixImin2:ixImax2),&
        MIN0wB02(ixImin1:ixImax1,ixImin2:ixImax2) 
    ...
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rho_)=rhobnd/x(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)**2
    ! vr is 10 km/s everywhere
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,mom(1))  = 2.0d0*w(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rho_)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,mom(2))  = 0.0d0
    ! at the inner boundary: differential rotation of the Sun
    ! vphi decreases like r^-2
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,mom(3))  = 0.0d0
 ...
 !       (gamma0+gamma2*dcos(x(ixO^S,2))**2+gamma4*dcos(x(ixO^S,2))**4)/x(ixO^S,1)**2
    ...
    do ix1=ixOmin1,ixOmax1
       do ix2=ixOmin2,ixOmax2  
             w(ix1,ix2,mag(1))  = Bbnd*2.0d0*dcos(x(ix1,ix2,&
                2)-shift_dip)/x(ix1,ix2,1)**3    
             w(ix1,ix2,mag(2))  = Bbnd*dsin(x(ix1,ix2,2)-shift_dip)/x(ix1,ix2,&
                1)**3
        enddo
    enddo
    ...
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_) = 1.d-8 + &
       1.67d-5*dexp(-(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1)-(xprobmin1))/0.1d0)*merge(1.d0, 0.d0, MAX0wB02(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) > 0.d0) !> small background everywhere to avoid steep gradients
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkplus_)  = 1.d-8 + &
       1.67d-5*dexp(-(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1)-(xprobmin1))/0.1d0)*merge(1.d0, 0.d0, MIN0wB02(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2) < 0.d0)

    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_) = 0.0d0 !1.d-6 + 1.67d-2*dexp(-(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)-(xprobmin1)))  !*merge(1.d0, 0.d0, MAX0wB02(ixOmin1:ixOmax1,ixOmin2:ixOmax2) > 0.d0)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAplus_)  = 0.0d0 !1.d-6  + 1.67d-2*dexp(-(x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)-(xprobmin1))) !*merge(1.d0, 0.d0, MIN0wB02(ixOmin1:ixOmax1,ixOmin2:ixOmax2) < 0.d0)
    
    !pressure decreases like 1/r^2 (T is thus fixed)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_)   = Tbnd*rhobnd/x(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)**2/(uawsom_gamma-one) &
                  +0.5d0*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     mom(1))**2+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     mom(2))**2+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     mom(3))**2)/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rho_) &
                  +0.5d0*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     mag(1))**2+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     mag(2))**2+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     mag(3))**2) &
                  +w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     wkplus_) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_) &
                  +w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
                     wAplus_) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_) !> Added wave energy to total energy calculation

    if(uawsom_glm) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,psi_)=0.0d0
  ...
  subroutine specialbound_usr(qt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    double precision :: th, lat, Br_arc, deltath, alpha, B0, arcade, shift_arc,&
        Bth_arc, shift_dip
    double precision :: shear1, v0_max1, deltat1, colat_shear1, shift_shear1,&
        v_shear1, delth_shear1, time_stop1  
    double precision :: shear2, v0_max2, deltat2, colat_shear2, shift_shear2,&
        v_shear2, delth_shear2, time_stop2    
   ...
   !               *(4.0d0*(omega+(v_shear1+v_shear2)/dsin(x(ixOmax1,ix2,2)))-3.0d0*w(ixOmax1+1,ix2,mom(3))/(x(ixOmax1+1,ix2,1)*dsin(x(ixOmax1+1,ix2,2))*w(ixOmax1+1,ix2,rho_)))
          ...
          w(ixOmax1,ix2,mag(2)) = w(ixOmax1+1,ix2,mag(2))*(x(ixOmax1+1,ix2,&
             1)**3)/(x(ixOmax1,ix2,1)**3)
          w(ixOmin1,ix2,mag(2)) = w(ixOmax1+1,ix2,mag(2))*(x(ixOmax1+1,ix2,&
             1)**3)/(x(ixOmin1,ix2,1)**3)

          ! r^2*Br is fixed at the inner boundary (this is how we force a dipole field for the Sun)
          w(ixOmax1,ix2,mag(1)) = (2.0d0*(2.0d0*Bbnd*dcos(x(ixOmax1,ix2,&
             2)-shift_dip))-w(ixOmax1+1,ix2,mag(1))*x(ixOmax1+1,ix2,&
             1)**2)/x(ixOmax1,ix2,1)**2
          w(ixOmin1,ix2,mag(1)) = (4.0d0*(2.0d0*Bbnd*dcos(x(ixOmin1,ix2,&
             2)-shift_dip))-3.0d0*w(ixOmax1+1,ix2,mag(1))*x(ixOmax1+1,ix2,&
             1)**2)/x(ixOmin1,ix2,1)**2

          !> MAX: Set injection of wave energy that propagates into the domain: merge ensures B0 dependence respected          
          w(ixOmin1,ix2,wkminus_) = 1.67d-5*merge(1.d0, 0.d0, w(ixOmax1+1,ix2,&
             mag(1)) > 0.d0) 
          w(ixOmax1,ix2,wkminus_) = 1.67d-5*merge(1.d0, 0.d0, w(ixOmax1+1,ix2,&
             mag(1)) > 0.d0)
          w(ixOmin1,ix2,wkplus_)  = 1.67d-5*merge(1.d0, 0.d0, w(ixOmax1+1,ix2,&
             mag(1)) < 0.d0)
          w(ixOmax1,ix2,wkplus_)  = 1.67d-5*merge(1.d0, 0.d0, w(ixOmax1+1,ix2,&
             mag(1)) < 0.d0)
          ...
          w(ixOmax1,ix2,mom(1)) = w(ixOmax1+1,ix2,mom(1))*(x(ixOmax1+1,ix2,&
             1)/x(ixOmax1,ix2,1))**2
          w(ixOmin1,ix2,mom(1)) = w(ixOmax1,ix2,mom(1))*(x(ixOmax1,ix2,&
             1)/x(ixOmin1,ix2,1))**2
          ...
          Pin = (uawsom_gamma-one)*(w(ixOmax1+1,ix2,e_)&
                   -0.5d0*(w(ixOmax1+1,ix2,mag(1))**2+w(ixOmax1+1,ix2,&
                      mag(2))**2+w(ixOmax1+1,ix2,mag(3))**2) &
                   -0.5d0*(w(ixOmax1+1,ix2,mom(1))**2+w(ixOmax1+1,ix2,&
                      mom(2))**2+w(ixOmax1+1,ix2,mom(3))**2)/w(ixOmax1+1,ix2,&
                      rho_) &
          ...
          Pg2 = w(ixOmin1,ix2,rho_)*(4.0d0*Tbnd-3.0d0*Pin/w(ixOmax1+1,ix2,&
             rho_))
          w(ixOmax1,ix2,e_)  = Pg1/(uawsom_gamma-one) &
                             + 0.5d0*(w(ixOmax1,ix2,mag(1))**2+w(ixOmax1,ix2,&
                                mag(2))**2+w(ixOmax1,ix2,mag(3))**2) &
                             + 0.5d0*(w(ixOmax1,ix2,mom(1))**2+w(ixOmax1,ix2,&
                                mom(2))**2+w(ixOmax1,ix2,mom(3))**2)/w(ixOmax1,&
                                ix2,rho_) &
                             + w(ixOmax1,ix2,wkplus_) + w(ixOmax1,ix2,&
                                wkminus_) &
                             + w(ixOmax1,ix2,wAplus_) + w(ixOmax1,ix2,&
                                wAminus_)
          w(ixOmin1,ix2,e_)  = Pg2/(uawsom_gamma-one) &
                             + 0.5d0*(w(ixOmin1,ix2,mag(1))**2+w(ixOmin1,ix2,&
                                mag(2))**2+w(ixOmin1,ix2,mag(3))**2) &
                             + 0.5d0*(w(ixOmin1,ix2,mom(1))**2+w(ixOmin1,ix2,&
                                mom(2))**2+w(ixOmin1,ix2,mom(3))**2)/w(ixOmin1,&
                                ix2,rho_) &
                             + w(ixOmin1,ix2,wkplus_) + w(ixOmin1,ix2,&
                                wkminus_) &
                             + w(ixOmin1,ix2,wAplus_) + w(ixOmin1,ix2,&
                                wAminus_)
       enddo
    ...
    case (2) ! Upper radial boundary
      ...
      do ix1=ixOmin1,ixOmax1
        do ix2=ixOmin2,ixOmax2
          ...
          w(ix1,ix2,rho_)  = w(ixOmin1-1,ix2,rho_)*(x(ixOmin1-1,ix2,1)/x(ix1,&
             ix2,1))**2

          ! r*r*rho*vr is continuous
          w(ix1,ix2,mom(1)) = w(ixOmin1-1,ix2,mom(1))*(x(ixOmin1-1,ix2,&
             1)/x(ix1,ix2,1))**2
          ...
          w(ix1,ix2,mom(3)) = w(ixOmin1-1,ix2,mom(3))/w(ixOmin1-1,ix2,&
             rho_)*x(ixOmin1-1,ix2,1)/x(ix1,ix2,1)*w(ix1,ix2,rho_)

          ! r*r*Br is continuous
          w(ix1,ix2,mag(1)) = w(ixOmin1-1,ix2,mag(1))*(x(ixOmin1-1,ix2,&
             1)/x(ix1,ix2,1))**2
          ...
          w(ix1,ix2,mag(3)) = w(ixOmin1-1,ix2,mag(3))*x(ixOmin1-1,ix2,1)/x(ix1,&
             ix2,1)
          ...
          w(ix1,ix2,wkminus_) = merge(w(ixOmin1-1,ix2,wkminus_), 0.d0,&
              w(ixOmin1-1,ix2,mag(1)) > 0.d0)
          w(ix1,ix2,wkplus_)  = merge(w(ixOmin1-1,ix2,wkplus_), 0.d0,&
              w(ixOmin1-1,ix2,mag(1)) < 0.d0)
          ...
          Ti=(uawsom_gamma-one)/w(ixOmin1-1,ix2,rho_)*(w(ixOmin1-1,ix2,e_)&
                  - 0.5d0*(w(ixOmin1-1,ix2,mag(1))**2+w(ixOmin1-1,ix2,&
                     mag(2))**2+w(ixOmin1-1,ix2,mag(3))**2) &
                  - 0.5d0*(w(ixOmin1-1,ix2,mom(1))**2+w(ixOmin1-1,ix2,&
                     mom(2))**2+w(ixOmin1-1,ix2,mom(3))**2)/w(ixOmin1-1,ix2,&
                     rho_) &
          ...
          w(ix1,ix2,e_) = Ti*w(ix1,ix2,rho_)/(uawsom_gamma-one) &
                            + 0.5d0*(w(ix1,ix2,mag(1))**2+w(ix1,ix2,&
                               mag(2))**2+w(ix1,ix2,mag(3))**2) &
                            + 0.5d0*(w(ix1,ix2,mom(1))**2+w(ix1,ix2,&
                               mom(2))**2+w(ix1,ix2,mom(3))**2)/w(ix1,ix2,&
                               rho_) &
  ...
  subroutine specialvar_output(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    double precision :: lr,lthin,lthout,Rin,Rout,c(ixImin1:ixImax1,&
       ixImin2:ixImax2)
    integer :: iw,ix1,ix2
    ...
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+4)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       mag(1))
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+5)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       mag(2))
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+6)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       mag(3))
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+7)=x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+8)=x(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       2)

    call get_current(w,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,&
       ixOmax2,idirmin,current)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+9)= current(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+10)= current(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,2)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+11)= current(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,3)
    w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+12)=dsqrt(current(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)**2+current(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       2)**2+current(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3)**2)
    ...
    do ix1=ixOmin1,ixOmax1
      do ix2=ixOmin2,ixOmax2
        ...
        Bt1 = dsqrt((w(ix1,ix2,mag(1))+w(ix1,ix2+1,mag(1)))**2/4.0d0 + (w(ix1,&
           ix2,mag(3))+w(ix1,ix2+1,mag(3)))**2/4.0d0)
        Bt2 = dsqrt((w(ix1,ix2,mag(2))+w(ix1+1,ix2,mag(2)))**2/4.0d0 + (w(ix1,&
           ix2,mag(3))+w(ix1+1,ix2,mag(3)))**2/4.0d0)
        Bt3 = dsqrt((w(ix1,ix2,mag(1))+w(ix1,ix2-1,mag(1)))**2/4.0d0 + (w(ix1,&
           ix2,mag(3))+w(ix1,ix2-1,mag(3)))**2/4.0d0)
        Bt4 = dsqrt((w(ix1,ix2,mag(2))+w(ix1-1,ix2,mag(2)))**2/4.0d0 + (w(ix1,&
           ix2,mag(3))+w(ix1-1,ix2,mag(3)))**2/4.0d0)
        ...
        c(ix1,ix2)=abs((S1+S2+S3+S4))/(Bt1*lr + Bt2*lthout + Bt3*lr + &
           Bt4*lthin)

        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,nw+13) = c(ix1,ix2)
  ...
  ! linear force-free background field
    ...
    double precision, intent(inout) :: wB0(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:ndir)
    integer :: ix1,ix2
    double precision :: Br_arc, Bth_arc, B0, alpha, deltath,&
        lat(ixImin1:ixImax1,ixImin2:ixImax2), arcade, shift_arc

    wB0(ixOmin1:ixOmax1,ixOmin2:ixOmax2,1)= wB0(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,1)
    wB0(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2)= wB0(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,2)
    wB0(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3)= 0.d0
  ...
  subroutine specialsource(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    double precision, intent(inout) :: w(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:nw)
    double precision :: sin2_thc,thc,hscale,TNow,TTarget,q0,TEquatorial,&
       TPolar
    ...
    !if(x(ix^D,1) < 30.0d0)then
       r  = x(ix1,ix2,1)
       th = x(ix1,ix2,2)
       Pth = (uawsom_gamma-one)*(wCT(ix1,ix2,e_)-0.5d0*(sum(wCT(ix1,ix2,&
          mom(:))**2)/wCT(ix1,ix2,rho_)+sum(wCT(ix1,ix2,mag(:))**2))-wCT(ix1,&
          ix2,wkminus_)-wCT(ix1,ix2,wkplus_)-wCT(ix1,ix2,wAminus_)-wCT(ix1,ix2,&
          wAplus_))
  ...
  !        TTarget = TPolar
  !     end if
       TNow = Pth/wCT(ix1,ix2,rho_)
       w(ix1,ix2,e_)  = w(ix1,ix2,e_)  + qdt*q0*wCT(ix1,ix2,&
          rho_)*(TTarget-TNow)*exp(-((r-1.0d0)/hscale)**2)
   ! endif
    end do
    end do
   ...
   subroutine specialrefine_grid(igrid,level,ixGmin1,ixGmin2,ixGmax1,ixGmax2,&
    ...
    double precision :: lr,lthin,lthout,Rin,Rout,c(ixGlo1:ixGhi1,&
       ixGlo2:ixGhi2)
    integer :: ix1,ix2
    double precision :: Bt1,Bt2,Bt3,Bt4
    double precision :: S1,S2,S3,S4
    ...
    if ( any(c(ixmin1:ixmax1,ixmin2:ixmax2) > 0.02d0) ) then
            refine = 1
            coarsen = -1
    else if ( all(c(ixmin1:ixmax1,ixmin2:ixmax2) < 0.01d0) ) then
            coarsen = 1
            refine = 0
    else
            coarsen = 0
    ...
    if ( any (((x(ixmin1:ixmax1,ixmin2:ixmax2,&
       1) < 2.5d0)) .and. ((abs(x(ixmin1:ixmax1,ixmin2:ixmax2,&
       2)-0.5d0*dpi) < 1.1d0))) ) then        
            refine=1
            coarsen=-1
    endif
    ...
    if ( any (((x(ixmin1:ixmax1,ixmin2:ixmax2,&
       1) > 2.5d0)) .and. ((x(ixmin1:ixmax1,ixmin2:ixmax2,&
       1) < 3.5d0)) .and. ((abs(x(ixmin1:ixmax1,ixmin2:ixmax2,&
       2)-0.5d0*dpi) < 0.95d0))) ) then
            refine=1
            coarsen=-1
    endif

    if ( any (((x(ixmin1:ixmax1,ixmin2:ixmax2,&
       1) > 3.5d0)) .and. ((x(ixmin1:ixmax1,ixmin2:ixmax2,&
       1) < 4.5d0)) .and. ((abs(x(ixmin1:ixmax1,ixmin2:ixmax2,&
       2)-0.5d0*dpi) < 0.75d0))) ) then
            refine=1
            coarsen=-1
    endif
    ...
    if ( (any(abs(x(ixmin1:ixmax1,ixmin2:ixmax2,&
       2)-0.5d0*dpi) > 0.5d0)) .AND. (any(x(ixmin1:ixmax1,ixmin2:ixmax2,&
       1) > 5.0d0))  ) then
            coarsen=1
            refine=-1
    endif
