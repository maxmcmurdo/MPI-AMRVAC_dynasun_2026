...
#include "amrvac.h"
  ...
  double precision, public, protected :: zeta0=2.0d0
...
!! end rad cool
  ...
  subroutine w_add_source(qdt,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    if(B0field) then
      B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         1:ndir)=wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         mag(1:ndir))+block%B0(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         1:ndir,0)
    else
      B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
    ...
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       ...
       ixOmin2:ixOmax2,ixOmin3:ixOmax3,3)**2)**0.5d0))**0.5d0
    ...
    if(qsourcesplit .eqv. .false.) then
      ...
      Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ixOmin3:ixOmax3) = (1/1.d8) * 1.5d5 * 1.0d2 * (1.d0 / &
         ((B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         1)**2.d0 + B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         2)**2 + B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         3)**2)**0.5d0))**0.5d0
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3,&
         ...
         wAplus_)*Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmin3:ixOmax3))
    endif
  ...
  subroutine get_zeta(w,x,ixImin1,ixImin2,ixImin3,ixImax1,ixImax2,ixImax3,&
    ...
    zeta(ixImin1:ixImax1,ixImin2:ixImax2,&
       ...
       ixImin3:ixImax3,3)-xprobmin3)/(5.d0*(6.961d10/unit_length)))+1.d0 
