...
!! end rad cool
      ...
      if(primitive) then
        ...
        if(uawsom_internal_e) then
          ...
          tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=w(ixOmin1:ixOmax1,&
             ...
             ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2) !Max: Added AW + kink
          if(has_equi_pe0) then
            tmp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = tmp(ixOmin1:ixOmax1,&
               ixOmin2:ixOmax2)+block%equi_vars(ixOmin1:ixOmax1,&
               ixOmin2:ixOmax2,equi_pe0_,0)*inv_gamma_1
    ...
    if(uawsom_energy) then
      if(uawsom_internal_e) then
        ...
        w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_)=w(ixOmin1:ixOmax1,&
           ...
           ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,ixOmax1,ixOmax2) !Max: Added AW + kink
        if(uawsom_solve_eaux) w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
           eaux_)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,paux_)*inv_gamma_1
      end if
    end if
  ...
  subroutine uawsom_ei_to_e(ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    w(ixImin1:ixImax1,ixImin2:ixImax2,e_)=w(ixImin1:ixImax1,ixImin2:ixImax2,&
       ...
       ixImax1,ixImax2,ixImin1,ixImin2,ixImax1,ixImax2) !Max: Added AW + kink
            ...
            if(uawsom_internal_e) then
              ...
              where(flag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_))
                w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_) = tmp2(ixOmin1:ixOmax1,&
                   ...
                   ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,ixOmax1,ixOmax2) !Max: Added AW + kink
             end where
              if(uawsom_solve_eaux) then
                where(flag(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_))
                  w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
          ...
          if(uawsom_energy) then
            ...
            if(.not.uawsom_internal_e) then
              w(ixImin1:ixImax1,ixImin2:ixImax2,e_)=w(ixImin1:ixImax1,&
                 ...
                 ixImin2,ixImax1,ixImax2,ixImin1,ixImin2,ixImax1,ixImax2) !Max: Added AW + Kink
            end if
            call small_values_average(ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,&
  ...
  subroutine uawsom_get_temperature_from_etot(w, x, ixImin1,ixImin2,ixImax1,&
    ...
    res(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=(gamma_1*(w(ixOmin1:ixOmax1,&
       ...
       ixOmin2,ixOmax1,ixOmax2))/w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,rho_) !Max: added AW + Kink
  ...
  subroutine uawsom_get_flux(wC,w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,&
    ...
    if(uawsom_energy) then 
      ptotal(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=w(ixOmin1:ixOmax1,&
         ...
         wAplus_) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_))/2.0d0 !Max: Added AW + Kink pressure
    else
    ...
    if(uawsom_energy) then
      if (uawsom_internal_e) then
        ...
        f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_)=w(ixOmin1:ixOmax1,&
           ...
           rho_)*((zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2)+1.d0)/(2.d0*(1+&
           ff*zeta(ixOmin1:ixOmax1,ixOmin2:ixOmax2)-ff))))**0.5d0)+&
    ...
    denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = sqrt(w(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,rho_)*((zeta(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2)+1.d0)/(2.d0*(1+ff*zeta(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2)-ff))))
    ...
    f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_)= w(ixOmin1:ixOmax1,&
       ...
       mom(idim))+w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       mag(idim))/denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
  ...
  subroutine uawsom_get_flux_split(wC,w,x,ixImin1,ixImin2,ixImax1,ixImax2,&
    ...
    ptotal(ixOmin1:ixOmax1,ixOmin2:ixOmax2)=pgas(ixOmin1:ixOmax1,&
       ...
       wkplus_) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       wkminus_))/4.d0+(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       wAplus_) + w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_))/2.d0 !Max: added AW + kink pressure
    ...
    if(uawsom_energy) then
      if (uawsom_internal_e) then
         ...
         f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_)=w(ixOmin1:ixOmax1,&
            ...
            rho_)*((zeta(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2)+1.d0)/(2.d0*(1+ff*zeta(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2)-ff))))**0.5d0) -w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            wkplus_)*B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            idim)/((w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            rho_)*((zeta(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2)+1.d0)/(2.d0*(1+ff*zeta(ixOmin1:ixOmax1,&
            ixOmin2:ixOmax2)-ff))))**0.5d0) +w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            wAminus_)*B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            idim)/(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
            rho_)**0.5d0) -w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
    ...
    f(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_)= w(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,wkminus_)*(w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       mom(idim))+B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       idim)/denom(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
    ...
    if (.not. qsourcesplit) then
      if(uawsom_internal_e) then
        ...
        call internal_energy_add_source(qdt,ixImin1,ixImin2,ixImax1,ixImax2,&
           ixOmin1,ixOmin2,ixOmax1,ixOmax2,wCT,w,x,e_,qsourcesplit,active)
      else
        if(uawsom_solve_eaux) then
          ! Source for auxiliary internal energy equation
          active = .true.
          call internal_energy_add_source(qdt,ixImin1,ixImin2,ixImax1,ixImax2,&
             ixOmin1,ixOmin2,ixOmax1,ixOmax2,wCT,w,x,eaux_,qsourcesplit,&
             active)
        endif
        if(has_equi_pe0) then
          active = .true.
  ...
  subroutine w_add_source(qdt,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    logical, intent(inout)          :: active
    double precision                :: v(ixImin1:ixImax1,ixImin2:ixImax2,&
       1:ndir), Bmag(ixImin1:ixImax1,ixImin2:ixImax2), B0(ixImin1:ixImax1,&
       ixImin2:ixImax2,3), Bpo, Bzo, y0, kx, Bref(ixImin1:ixImax1,&
       ixImin2:ixImax2,3)
    double precision                :: divv(ixImin1:ixImax1,ixImin2:ixImax2),&
    ...
    double precision                :: vA1(ixImin1:ixImax1,ixImin2:ixImax2),&
       vA2(ixImin1:ixImax1,ixImin2:ixImax2),vA3(ixImin1:ixImax1,&
       ixImin2:ixImax2),gradvA1(ixImin1:ixImax1,ixImin2:ixImax2),&
       gradvA2(ixImin1:ixImax1,ixImin2:ixImax2),gradvA3(ixImin1:ixImax1,&
       ixImin2:ixImax2),refvA(ixImin1:ixImax1,ixImin2:ixImax2),&
       lnvA1(ixImin1:ixImax1,ixImin2:ixImax2),lnvA2(ixImin1:ixImax1,&
       ixImin2:ixImax2),lnvA3(ixImin1:ixImax1,ixImin2:ixImax2),&
        gradlnvA1(ixImin1:ixImax1,ixImin2:ixImax2) , gradlnvA2(ixImin1:ixImax1,&
       ixImin2:ixImax2) , gradlnvA3(ixImin1:ixImax1,ixImin2:ixImax2) 
    double precision                :: vk1(ixImin1:ixImax1,ixImin2:ixImax2),&
       vk2(ixImin1:ixImax1,ixImin2:ixImax2),vk3(ixImin1:ixImax1,&
       ixImin2:ixImax2),gradvk1(ixImin1:ixImax1,ixImin2:ixImax2),&
       gradvk2(ixImin1:ixImax1,ixImin2:ixImax2),gradvk3(ixImin1:ixImax1,&
       ixImin2:ixImax2),refvk(ixImin1:ixImax1,ixImin2:ixImax2),&
       lnvk1(ixImin1:ixImax1,ixImin2:ixImax2),lnvk2(ixImin1:ixImax1,&
       ixImin2:ixImax2),lnvk3(ixImin1:ixImax1,ixImin2:ixImax2),&
        gradlnvk1(ixImin1:ixImax1,ixImin2:ixImax2) , gradlnvk2(ixImin1:ixImax1,&
       ixImin2:ixImax2) , gradlnvk3(ixImin1:ixImax1,ixImin2:ixImax2) 
    integer                         :: ix1, ix2, ix3, idirmin

    double precision :: eps_small = 1.0d-30
    double precision :: F(ixImin1:ixImax1,ixImin2:ixImax2),&
        Ref(ixImin1:ixImax1,ixImin2:ixImax2), b_1(ixImin1:ixImax1,&
       ixImin2:ixImax2), b_2(ixImin1:ixImax1,ixImin2:ixImax2),&
        b_3(ixImin1:ixImax1,ixImin2:ixImax2), d_lnvA_1(ixImin1:ixImax1,&
       ixImin2:ixImax2), d_lnvA_2(ixImin1:ixImax1,ixImin2:ixImax2),&
        d_lnvA_3(ixImin1:ixImax1,ixImin2:ixImax2), term1(ixImin1:ixImax1,&
       ixImin2:ixImax2), curlv(ixImin1:ixImax1,ixImin2:ixImax2,1:ndir),&
        term2(ixImin1:ixImax1,ixImin2:ixImax2), Rimb(ixImin1:ixImax1,&
       ixImin2:ixImax2), Rlim(ixImin1:ixImax1,ixImin2:ixImax2),&
        vA(ixImin1:ixImax1,ixImin2:ixImax2), lnvA(ixImin1:ixImax1,&
       ixImin2:ixImax2)
    double precision :: Fk(ixImin1:ixImax1,ixImin2:ixImax2),&
        Refk(ixImin1:ixImax1,ixImin2:ixImax2), v_1(ixImin1:ixImax1,&
       ixImin2:ixImax2), v_2(ixImin1:ixImax1,ixImin2:ixImax2),&
        v_3(ixImin1:ixImax1,ixImin2:ixImax2), d_lnvk_1(ixImin1:ixImax1,&
       ixImin2:ixImax2), d_lnvk_2(ixImin1:ixImax1,ixImin2:ixImax2),&
        d_lnvk_3(ixImin1:ixImax1,ixImin2:ixImax2), vk(ixImin1:ixImax1,&
       ixImin2:ixImax2), lnvk(ixImin1:ixImax1,ixImin2:ixImax2),&
        term1k(ixImin1:ixImax1,ixImin2:ixImax2), Rlimk(ixImin1:ixImax1,&
       ixImin2:ixImax2), Rimbk(ixImin1:ixImax1,ixImin2:ixImax2),&
    ...
    Bmag(ixImin1:ixImax1,ixImin2:ixImax2) = (B(ixImin1:ixImax1,ixImin2:ixImax2,&
       1)**2.d0 + B(ixImin1:ixImax1,ixImin2:ixImax2,&
       2)**2.d0 + B(ixImin1:ixImax1,ixImin2:ixImax2,3)**2.d0)**0.5d0
    
    !> Below works fine for 1-3D.
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 1.d8/unit_length * &
       ((Busr/unit_magneticfield)/Bmag(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2))**0.5d0 !> 1Mm * sqrt(B_0/B)
    ...
    if(qsourcesplit .eqv. .false.) then
      ...
      call get_zeta(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixImin1,ixImin2,&
         ixImax1,ixImax2,zeta)
      ...
      Lperp(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = (zeta(ixOmin1:ixOmax1,&
         ...
         0.5d0*radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2) !/min(pth(ixOmin1:ixOmax1,ixOmin2:ixOmax2),1.d0) 


      ! Max: This is the last term in Eqn. 78 TVD 2024 contribution due to AWs is zero since mu*rho*alpha**2-1 = 0
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,e_) = w(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,e_)-qdt*(zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)-1.d0)/(zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)+1.d0)*(zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)+1.d0)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         wkplus_) + wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
      ...
      Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = &
         (1.5d9/unit_length)*(1.d0/Bmag(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2))**0.5d0

      Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2) =  (2.0d0 / &
         Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2)) * (wCT(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, wAminus_)/wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         rho_))**0.5d0
      Gamma_minus(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = (2.0d0 / &
         Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2)) * (wCT(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2, wAplus_)/wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         rho_))**0.5d0

      if(B0field) then
        Bref(ixImin1:ixImax1,ixImin2:ixImax2,1:ndir)=wCT(ixImin1:ixImax1,&
           ixImin2:ixImax2,mag(1:ndir))+block%B0(ixImin1:ixImax1,&
           ixImin2:ixImax2,1:ndir,0) !> Magnetic field pertubations change the radius of flux tube
      else
        Bref(ixImin1:ixImax1,ixImin2:ixImax2,1:ndir)=wCT(ixImin1:ixImax1,&
           ixImin2:ixImax2,mag(1:ndir)) 
      end if

      Bmagref(ixImin1:ixImax1,ixImin2:ixImax2) = (Bref(ixImin1:ixImax1,&
         ixImin2:ixImax2,1)**2.d0 + Bref(ixImin1:ixImax1,ixImin2:ixImax2,&
         2)**2 + Bref(ixImin1:ixImax1,ixImin2:ixImax2,3)**2)**0.5d0

      vA(ixImin1:ixImax1,ixImin2:ixImax2) = Bmagref(ixImin1:ixImax1,&
         ixImin2:ixImax2)/dsqrt(wCT(ixImin1:ixImax1,ixImin2:ixImax2,rho_)) !> vA = B/sqrt(rho_avg)
      vk(ixImin1:ixImax1,ixImin2:ixImax2) = Bmagref(ixImin1:ixImax1,&
         ixImin2:ixImax2)/dsqrt(0.5d0*wCT(ixImin1:ixImax1,ixImin2:ixImax2,&
         rho_)*(1+zeta(ixImin1:ixImax1,ixImin2:ixImax2))*((1+&
         ff*zeta(ixImin1:ixImax1,ixImin2:ixImax2)-ff)**(-1.d0))) !> vk = B/(sqrt(rho_i+rho_e/2))
      lnvA(ixImin1:ixImax1,ixImin2:ixImax2) = log(vA(ixImin1:ixImax1,&
         ixImin2:ixImax2))
      lnvk(ixImin1:ixImax1,ixImin2:ixImax2) = log(vk(ixImin1:ixImax1,&
         ixImin2:ixImax2))

      b_1(ixImin1:ixImax1,ixImin2:ixImax2) = Bref(ixImin1:ixImax1,&
         ixImin2:ixImax2,1)/Bmagref(ixImin1:ixImax1,ixImin2:ixImax2)
      b_2(ixImin1:ixImax1,ixImin2:ixImax2) = Bref(ixImin1:ixImax1,&
         ixImin2:ixImax2,2)/Bmagref(ixImin1:ixImax1,ixImin2:ixImax2)
      b_3(ixImin1:ixImax1,ixImin2:ixImax2) = Bref(ixImin1:ixImax1,&
         ixImin2:ixImax2,3)/Bmagref(ixImin1:ixImax1,ixImin2:ixImax2)

      call gradient(lnvA,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,1,d_lnvA_1)
      call gradient(lnvA,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,2,d_lnvA_2)
      call gradient(lnvA,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,3,d_lnvA_3)

      call gradient(lnvk,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,1,d_lnvk_1)
      call gradient(lnvk,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,2,d_lnvk_2)
      call gradient(lnvk,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2,3,d_lnvk_3) 

      term1(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = vA(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) * (b_1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*d_lnvA_1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + b_2*d_lnvA_2(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + b_3*d_lnvA_3(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
      term1k(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = vk(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) * (b_1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*d_lnvk_1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + b_2*d_lnvk_2(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + b_3*d_lnvk_3(ixOmin1:ixOmax1,ixOmin2:ixOmax2))

      !> coordinate indpendent calculation at wCT of b.curlv
      call uawsom_get_v(wCT,x,ixImin1,ixImin2,ixImax1,ixImax2,ixImin1,ixImin2,&
         ixImax1,ixImax2,v)
      call curlvector(v, ixImin1,ixImin2,ixImax1,ixImax2, ixOmin1,ixOmin2,&
         ixOmax1,ixOmax2, curlv, idirmin, 1, 3)
      term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = b_1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*curlv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         1) + b_2(ixOmin1:ixOmax1,ixOmin2:ixOmax2)*curlv(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2,2) + b_3(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*curlv(ixOmin1:ixOmax1,ixOmin2:ixOmax2,3)
      
      Rimb(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = sqrt(term1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*term1(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + term2(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2))
      Rimbk(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = sqrt(term1k(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*term1k(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + term2(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*term2(ixOmin1:ixOmax1,ixOmin2:ixOmax2))

      Rlim(ixOmin1:ixOmax1,ixOmin2:ixOmax2)  = min(Rimb(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2), max(Gamma_plus(ixOmin1:ixOmax1,ixOmin2:ixOmax2),&
          Gamma_minus(ixOmin1:ixOmax1,ixOmin2:ixOmax2)))
      Rlimk(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = min(Rimbk(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2), max(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         wkplus_)**(1.d0/2.d0)/(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         rho_)*(1+ff*zeta(ixOmin1:ixOmax1,&
      ...
      Fk(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 0.0d0
      ...
      Ref(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = Rlim(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) * F(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
      Refk(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = Rlimk(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) * Fk(ixOmin1:ixOmax1,ixOmin2:ixOmax2)
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkminus_) = w(ixOmin1:ixOmax1,&
         ...
         rho_)*(1+ff*zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)-ff)**(-1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2) + Refk(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         wkminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkplus_))**0.5d0) 
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wkplus_)  = w(ixOmin1:ixOmax1,&
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAminus_) = w(ixOmin1:ixOmax1,&
         ...
         ixOmin2:ixOmax2) + Ref(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         wAminus_)*wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,wAplus_))**0.5d0) 
  ...
  subroutine internal_energy_add_source(qdt,ixImin1,ixImin2,ixImax1,ixImax2,&
     ixOmin1,ixOmin2,ixOmax1,ixOmax2,wCT,w,x,ie,qsourcesplit,active)
    use mod_global_parameters
    use mod_geometry
    use, intrinsic :: ieee_arithmetic
    ...
    double precision                :: Bmag(ixImin1:ixImax1,ixImin2:ixImax2),&
        B0(ixImin1:ixImax1,ixImin2:ixImax2,3)
    double precision                :: Lperp(ixImin1:ixImax1,ixImin2:ixImax2),&
       Lperp_AW(ixImin1:ixImax1,ixImin2:ixImax2),Gamma_minus(ixImin1:ixImax1,&
       ixImin2:ixImax2),Gamma_plus(ixImin1:ixImax1,ixImin2:ixImax2),&
       radius(ixImin1:ixImax1,ixImin2:ixImax2),zeta(ixImin1:ixImax1,&
       ixImin2:ixImax2),B(ixImin1:ixImax1,ixImin2:ixImax2,3)
    double precision :: Bref(ixImin1:ixImax1,ixImin2:ixImax2,3),&
        Bmagref(ixImin1:ixImax1,ixImin2:ixImax2), vA(ixImin1:ixImax1,&
       ixImin2:ixImax2), vk(ixImin1:ixImax1,ixImin2:ixImax2),&
        lnvA(ixImin1:ixImax1,ixImin2:ixImax2), lnvk(ixImin1:ixImax1,&
       ixImin2:ixImax2), b_1(ixImin1:ixImax1,ixImin2:ixImax2),&
        b_2(ixImin1:ixImax1,ixImin2:ixImax2), b_3(ixImin1:ixImax1,&
       ixImin2:ixImax2)
    double precision :: d_lnvA_1(ixImin1:ixImax1,ixImin2:ixImax2),&
        d_lnvA_2(ixImin1:ixImax1,ixImin2:ixImax2), d_lnvA_3(ixImin1:ixImax1,&
       ixImin2:ixImax2), d_lnvk_1(ixImin1:ixImax1,ixImin2:ixImax2),&
        d_lnvk_2(ixImin1:ixImax1,ixImin2:ixImax2), d_lnvk_3(ixImin1:ixImax1,&
       ixImin2:ixImax2), term1(ixImin1:ixImax1,ixImin2:ixImax2)
    double precision :: term1k(ixImin1:ixImax1,ixImin2:ixImax2),&
        v_r(ixImin1:ixImax1,ixImin2:ixImax2), v_theta(ixImin1:ixImax1,&
       ixImin2:ixImax2), v_phi(ixImin1:ixImax1,ixImin2:ixImax2),&
        term2(ixImin1:ixImax1,ixImin2:ixImax2), curlv(ixImin1:ixImax1,&
       ixImin2:ixImax2,1:ndir)
    double precision :: Fk(ixImin1:ixImax1,ixImin2:ixImax2),&
       Ref(ixImin1:ixImax1,ixImin2:ixImax2),Refk(ixImin1:ixImax1,&
       ixImin2:ixImax2),Rimb(ixImin1:ixImax1,ixImin2:ixImax2),&
       Rimbk(ixImin1:ixImax1,ixImin2:ixImax2),Rlim(ixImin1:ixImax1,&
       ixImin2:ixImax2),Rlimk(ixImin1:ixImax1,ixImin2:ixImax2),&
       F(ixImin1:ixImax1,ixImin2:ixImax2),eps_small
    
    double precision :: dxa1,dxa2, startpos1,startpos2, xlen1, xlen2, xlen3,&
        ixbc1,ixbc2
    integer          :: ix1,ix2, idirmin, ngl
    ...
    Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = (B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
       1)**2.d0 + B(ixOmin1:ixOmax1,ixOmin2:ixOmax2,2)**2 + B(ixOmin1:ixOmax1,&
       ixOmin2:ixOmax2,3)**2)**0.5d0
    
    radius(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = 1.d8/unit_length * &
       (0.5d0/Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2))**0.5d0 !> for lmax = 5 with low res run 24x48x96, <|B_surf|> = 0.53 (unit_B)
    ...
    if(qsourcesplit .eqv. .false.) then
      ...
      Lperp_AW(ixOmin1:ixOmax1,ixOmin2:ixOmax2) = &
         0.05d0*(1.0d0/Bmag(ixOmin1:ixOmax1,ixOmin2:ixOmax2))**0.5d0 !> Cooper Downs Lperp_AW fix 1.d0 to base B
      ...
      w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ie)=w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         ...
         rho_)*(1+ff*zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)-ff)**(-1.d0))**0.5d0/Lperp(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)) -qdt*(zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)-1.d0)/(zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)+1.d0)*(zeta(ixOmin1:ixOmax1,&
         ixOmin2:ixOmax2)+1.d0)*(wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
         wkplus_) + wCT(ixOmin1:ixOmax1,ixOmin2:ixOmax2,&
  ...
  subroutine get_zeta(w,x,ixImin1,ixImin2,ixImax1,ixImax2,ixOmin1,ixOmin2,&
    ...
    zeta(ixImin1:ixImax1,ixImin2:ixImax2) = &
       ...
       2)-xprobmin2)/(5.d0*6.961d10/unit_length))+1.d0 
