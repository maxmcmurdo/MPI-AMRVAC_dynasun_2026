...
!! end rad cool
  ...
  subroutine get_zeta(w,x,ixImin1,ixImax1,ixOmin1,ixOmax1,zeta)
    ...
    !zeta(ixI^S) = (zeta0-1.d0)*exp(-(x(ixI^S,1)-xprobmin1)/5.d0)+1.d0 !> Open field 
    zeta(ixImin1:ixImax1) = (zeta0-1.d0)*exp(-((xprobmax1-xprobmin1)/dpi * &
       sin(dpi * (x(ixImin1:ixImax1,1)-xprobmin1)/(xprobmax1-&
       xprobmin1)))/5.d0)+1.d0 !> 1D Loops
