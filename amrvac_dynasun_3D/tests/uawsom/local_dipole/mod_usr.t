...
contains
  ...
  subroutine initonegrid_usr(ixI^L,ixO^L,w,x)
    ...
    double precision :: MAX0wB03(ixO^S), MIN0wB03(ixO^S)
    ...
    MAX0wB03(ixO^S) = max(0.0d0,w(ixO^S,mag(3)))
    MIN0wB03(ixO^S) = min(0.0d0,w(ixO^S,mag(3)))
    
    w(ixO^S,wkminus_) = 1.d-7 + 1.d-1*dexp(-(x(ixO^S,3)-(xprobmin3))/1.0d0)*merge(1.d0, 0.d0, MAX0wB03(ixO^S) > 0.d0)
    w(ixO^S,wkplus_) = 1.d-7 + 1.d-1*dexp(-(x(ixO^S,3)-(xprobmin3))/1.0d0)*merge(1.d0, 0.d0, MIN0wB03(ixO^S) < 0.d0)
  ...
  subroutine specialbound_usr(qt,ixI^L,ixO^L,iB,w,x)
    ...
    double precision :: A(ixI^S,1:ndim)
    double precision :: Bfr(ixI^S,1:ndir)
    double precision :: MIN0wB03G(ixI^S), MAX0wB03G(ixI^S)

    if(uawsom_glm) w(ixO^S,psi_)=0.d0
    select case(iB)
     case(1)
     ...
     case(5) 
      w(ixO^S,mom(1))=-w(ixOmin1:ixOmax1,ixOmin2:ixOmax2,ixOmax3+nghostcells:ixOmax3+1:-1,mom(1))/&
       ...
       MAX0wB03G(ixI^S) = max(0.0d0,w(ixI^S,mag(3)))
       MIN0wB03G(ixI^S) = min(0.0d0,w(ixI^S,mag(3)))

       do ix2=ixOmin2,ixOmax2
        do ix1=ixOmin1,ixOmax1
         w(ix1,ix2,ixOmin3,wkminus_) = 1.0d-1*merge(1.d0, 0.d0, MAX0wB03G(ix1,ix2,ixOmin3) > 0.d0)  !+ 5.0d-1*(0.0d0+1.0d0*MAX0wB02G(ix1,ixOmax2)) 
         w(ix1,ix2,ixOmax3,wkminus_) = 1.0d-1*merge(1.d0, 0.d0, MAX0wB03G(ix1,ix2,ixOmin3) > 0.d0)  !+ 5.0d-1*(0.0d0+1.0d0*MAX0wB02G(ix1,ixOmax2)) 

         w(ix1,ix2,ixOmin3,wkplus_) =  1.0d-1*merge(1.d0, 0.d0, MIN0wB03G(ix1,ix2,ixOmin3) < 0.d0)  !- 1.0d-1*(-0.0d0+1.0d0*MIN0wB02G(ix1,ixOmax2))
         w(ix1,ix2,ixOmax3,wkplus_) =  1.0d-1*merge(1.d0, 0.d0, MIN0wB03G(ix1,ix2,ixOmin3) < 0.d0)  !- 1.0d-1*(-0.0d0+1.0d0*MIN0wB02G(ix1,ixOmax2))

         w(ix1,ix2,ixOmin3,wAminus_) = 0.0d-1*merge(1.d0, 0.d0, MAX0wB03G(ix1,ix2,ixOmin3) > 0.d0)  !+ 5.0d-1*(0.0d0+1.0d0*MAX0wB02G(ix1,ixOmax2)) 
         w(ix1,ix2,ixOmax3,wAminus_) = 0.0d-1*merge(1.d0, 0.d0, MAX0wB03G(ix1,ix2,ixOmin3) > 0.d0)  !+ 5.0d-1*(0.0d0+1.0d0*MAX0wB02G(ix1,ixOmax2)) 
        
         w(ix1,ix2,ixOmin3,wAplus_) =  0.0d-1*merge(1.d0, 0.d0, MIN0wB03G(ix1,ix2,ixOmin3) < 0.d0)  !- 1.0d-1*(-0.0d0+1.0d0*MIN0wB02G(ix1,ixOmax2))
         w(ix1,ix2,ixOmax3,wAplus_) =  0.0d-1*merge(1.d0, 0.d0, MIN0wB03G(ix1,ix2,ixOmin3) < 0.d0)  !- 1.0d-1*(-0.0d0+1.0d0*MIN0wB02G(ix1,ixOmax2))
        end do
       end do
  ...
  subroutine specialvar_output(ixI^L,ixO^L,w,x,normconv)
    ...
    call uawsom_get_pthermal(w,x,ixI^L,ixO^L,tmp)
    where(B2(ixO^S)/=0.d0)
